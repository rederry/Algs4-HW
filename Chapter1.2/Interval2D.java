...
//        for (int i = 0; i < N; i++) {
//            Interval1D x = new Interval1D(StdRandom.uniform(min, mid), StdRandom.uniform(mid, max));
//            Interval1D y = new Interval1D(StdRandom.uniform(min, mid), StdRandom.uniform(mid, max));            
//            Interval2D s = new Interval2D(x, y);
//            s.draw();
//        }
        String a = "hello";
        String b = a;
